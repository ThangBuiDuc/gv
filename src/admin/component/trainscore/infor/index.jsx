...
import ClassInit from "./classInit";
    ...
    return (
      <div className="wrapAdmin">
        <div className="flex justify-center">
          <h2 className="text-primary">Thông tin đánh giá trong kỳ</h2>
        </div>
        <ReactLoading
          type="spin"
          color="#0083C2"
    ...
    <div className="wrapAdmin">
      ...
      batch?.data.school_year !== eduBatch?.data.manamhoc ? (
        <div className="flex justify-center flex-col gap-[10px]">
          <h3 className="text-primary text-center">Khởi tạo học kỳ mới</h3>
      ...
      <div className="flex justify-center flex-col gap-[10px]">
        <h3 className="text-primary text-center">
          Thông tin các lớp hành chính đánh giá trong kỳ
        </h3>
        <ClassInit />
      </div>
    </div>
