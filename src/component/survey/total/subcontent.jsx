    ...
    <>
      <div className="flex justify-around">
        <p>
          ...
          <span className="font-semibold">
            {dataCourse.student_result ? dataCourse.student_result : "NULL"}
          </span>
        </p>
        <p>
        ...
        <p>
          ...
          <span className="font-semibold">
            {dataCourse.qldt_result ? dataCourse.qldt_result : "NULL"}
          </span>
        </p>
      </div>
      <div className="flex justify-center">
        <p>
          Điểm tổng:{" "}
          <span className="font-semibold">
            {dataCourse.result_evaluate ? dataCourse.result_evaluate : "NULL"}
          </span>
        </p>
      </div>
